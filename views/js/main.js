...
This js file was modified to increase responsiveness to user scroll, pizza resizing.
During load time a copy of the array generated by document.querySelectorAll is saved in
AvailablePizzas[] and items[] for all subsequent use.
UpdatePositions() has been modified to minimize time taken in loop
ChangePizzaSizes() has been modified to spend less time in loop
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Save a copy of all data on the pizzas for subsequent use in program
